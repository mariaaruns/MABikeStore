...
namespace BikeStore.Persistence.Migrations
{
    ...
    [Migration("20250301081726_modifiedRepairServicetable")]
    partial class modifiedRepairServicetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeStore.Domain.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Domain.Models.Payment", b =>
                {
                    b.HasOne("BikeStore.Domain.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("BikeStore.Domain.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
